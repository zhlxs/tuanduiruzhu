...
@XmlType(name = "", propOrder = { "hotelname" })
@XmlRootElement(name = "GethHotelcodeNew")
public class GethHotelcodeNew {

	@XmlElementRef(name = "hotelname", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
