...
@XmlRootElement(name = "gnlkAddResponse")
public class GnlkAddResponse {

    @XmlElementRef(name = "return", namespace = "http://service.tch.com", type = JAXBElement.class, required = false)
