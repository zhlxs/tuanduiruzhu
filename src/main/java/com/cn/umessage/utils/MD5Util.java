...
public class MD5Util {
	...
	/*
	 * MD5 TEST public static void main(String[] args) { try {
	 * System.out.println(getMD5(
	 * "D:/work/BJ/ESB_CSS_CSS_ImportCustCompFormRejectInfoSrv.xml")); } catch
	 * (NoSuchAlgorithmException e) { e.printStackTrace(); } catch (IOException
	 * e) { e.printStackTrace(); } }
	 */
}